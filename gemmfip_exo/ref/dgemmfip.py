...
def dgemmfip_mcxnr_getref(
    ...
    def dgemmfip_notrans_notrans_mcxnr_ref(
        num_mr: size,
        k: size,
        rsC: size,
        rsA: size,
    ...
    def dgemmfip_trans_notrans_mcxnr_ref(
        num_mr: size,
        k: size,
        rsC: size,
        rsA: size,
    ...
    if not a_transpose:
        return proc(dgemmfip_notrans_notrans_mcxnr_ref)
    else:
        return proc(dgemmfip_trans_notrans_mcxnr_ref)
